...
export default function Footer() {
  ...
  return (
    <footer className="bg-canvas border-t-2 border-ink py-12 sm:py-16 text-ink">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-12">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 pb-10 sm:pb-12 border-b-2 border-ink/10">
          <div className="space-y-2">
            <Link
              href="/"
              className="font-display font-black text-2xl sm:text-3xl tracking-tighter text-ink flex items-center gap-2"
            >
              <div className="w-8 h-8 rounded-lg bg-ink text-white flex items-center justify-center text-sm font-mono font-bold shadow-tactile-sm">
                R
              </div>
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-xs font-display font-bold uppercase tracking-wider">
        ...
        {/* Bottom Metadata Row */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-ink-muted text-center sm:text-left">
          <div>
